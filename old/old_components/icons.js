...
export const SvgOpen = props => (
  <Svg width="2.5em" height="2em" viewBox="0 0 57 38" {...props}>
    <path data-name="Line 1" fill="none" strokeLinecap="round" strokeWidth={6} d="M3 3h51" />
    <path data-name="Line 2" fill="none" strokeLinecap="round" strokeWidth={6} d="M3 19h51" />
    <path data-name="Line 3" fill="none" strokeLinecap="round" strokeWidth={6} d="M3 35h51" />
  </Svg>
);
